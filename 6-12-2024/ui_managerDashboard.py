...
"}")
        ...
        self.inventoryButton_2.setStyleSheet(u"QPushButton{\n"
...
"font-size: 16px;}")
        ...
        self.employeeButton_2.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(218, 211, 190);\n"
"color: black;\n"
"\n"
"font-size: 16px;}")
        ...
        self.historyButton_2.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(218, 211, 190);\n"
"color: black;\n"
"\n"
"font-size: 16px;}")
        ...
        self.logOutButton_2.setStyleSheet(u"QPushButton{\n"
"background-color: rgb(218, 211, 190);\n"
"color: black;\n"
"\n"
"font-size: 16px;}")
        ...
        self.products_2.horizontalHeader().setVisible(True)
        self.products_2.horizontalHeader().setCascadingSectionResizes(False)
        self.products_2.horizontalHeader().setHighlightSections(False)
        self.products_2.horizontalHeader().setStretchLastSection(False)
        self.products_2.verticalHeader().setVisible(False)
        self.products_2.verticalHeader().setHighlightSections(False)
        ...
        self.employeeNavigation.setStyleSheet(u"QFrame{\n"
"background-color: rgb(107, 138, 122)\n"
"}")
...
"font-size: 16px;}")
        ...
        self.title_3.setStyleSheet(u"QFrame{\n"
"background-color: rgb(107, 138, 122)n}")
        ...
        self.employeeList.setStyleSheet(u"QFrame{\n"
"background-color: rgb(107, 138, 122)\n"
"}")
        ...
        if (self.employees.columnCount() < 7):
            self.employees.setColumnCount(7)
...
"")
        ...
        self.history.setHorizontalHeaderItem(0, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(1, __qtablewidgetitem14)
        __qtablewidgetitem15 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(2, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(3, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(4, __qtablewidgetitem17)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(5, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.history.setHorizontalHeaderItem(6, __qtablewidgetitem19)
        ...
        self.history_2.setHorizontalHeaderItem(0, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(1, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(2, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(3, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(4, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(5, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.history_2.setHorizontalHeaderItem(6, __qtablewidgetitem26)
    ...
    def retranslateUi(self, Form):
        ...
        ___qtablewidgetitem12.setText(QCoreApplication.translate("Form", u"Action", None));
        self.title_4.setText(QCoreApplication.translate("Form", u"TRANSACTION HISTORY", None))
        ___qtablewidgetitem13 = self.history.horizontalHeaderItem(0)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("Form", u"Receipt ID", None));
        ___qtablewidgetitem14 = self.history.horizontalHeaderItem(1)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("Form", u"Customer Name", None));
        ___qtablewidgetitem15 = self.history.horizontalHeaderItem(2)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("Form", u"product", None));
        ___qtablewidgetitem16 = self.history.horizontalHeaderItem(3)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("Form", u"Quantity", None));
        ___qtablewidgetitem17 = self.history.horizontalHeaderItem(4)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("Form", u"Price", None));
        ___qtablewidgetitem18 = self.history.horizontalHeaderItem(5)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("Form", u"Total Charge", None));
        ___qtablewidgetitem19 = self.history.horizontalHeaderItem(6)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("Form", u"Date Purchase", None));
        self.historyList.setTabText(self.historyList.indexOf(self.PurchaseHistory), "")
        ___qtablewidgetitem20 = self.history_2.horizontalHeaderItem(0)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("Form", u"Service ID", None));
        ___qtablewidgetitem21 = self.history_2.horizontalHeaderItem(1)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("Form", u"Customer Name", None));
        ___qtablewidgetitem22 = self.history_2.horizontalHeaderItem(2)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("Form", u"Device", None));
        ___qtablewidgetitem23 = self.history_2.horizontalHeaderItem(3)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("Form", u"Service Type", None));
        ___qtablewidgetitem24 = self.history_2.horizontalHeaderItem(4)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("Form", u"Technician", None));
        ___qtablewidgetitem25 = self.history_2.horizontalHeaderItem(5)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("Form", u"Charge", None));
        ___qtablewidgetitem26 = self.history_2.horizontalHeaderItem(6)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("Form", u"Date", None));
